...
data_path = path[:root_dir_index+1]+['CheckPoints','SkipNet','CIFAR100']
data_path = '/'.join(data_path)

model_path = os.path.join(data_path,'skipnet_100.pth.tar')

args.model = 'cifar100_rnn_gate_110'
args.dataset = 'cifar100'
args.resume = model_path
args.cmd = 'test'
args.arch = 'cifar100_rnn_gate_110'
args.batch_size = 1
