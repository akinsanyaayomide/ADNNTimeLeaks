...
data_path = path[:root_dir_index+1]+['CheckPoints','RANet','CIFAR100']
data_path = '/'.join(data_path)
model_path = os.path.join(data_path,'ranet_cifar100.pth.tar')
...
threshold = [ 9.9999942e-01,  9.9773e-01,  9.9245e-01,  9.5594e-01,  8.2895e-01,
        -1.0000e+08]
#device = torch.device('cuda') if torch.cuda.is_available() else torch.device('cpu')
#model = RANet(args)
#model.to(device)
