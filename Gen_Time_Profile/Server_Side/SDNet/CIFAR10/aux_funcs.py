...
from data import CIFAR10, CIFAR100, TinyImagenet,CANCERDataColl,TRAITDataColl
...
def load_tinyimagenet(batch_size):
    tiny_imagenet = TRAITDataColl()
    return tiny_imagenet

def load_cancer(batch_size):
    cancer_data = CANCERDataColl(batch_size=batch_size)
    return cancer_data
