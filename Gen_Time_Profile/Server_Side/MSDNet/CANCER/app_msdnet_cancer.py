...
data_path = path[:root_dir_index+1]+['CheckPoints','MSDNet','CANCER']
data_path = '/'.join(data_path)

model.to(device)
model_path = os.path.join(data_path,'msdnet_cancer.pth.tar')
...
lax = [ 9.99642e-01,  9.99330e-01,  9.9245e-01, 9.7337e-01, 9.5594e-01,  8.2895e-01,
         -1.0000e+08]
