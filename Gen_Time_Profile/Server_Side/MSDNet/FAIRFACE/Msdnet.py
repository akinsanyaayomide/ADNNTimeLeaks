...
class MSDNet(nn.Module):
    def __init__(self, args,exit_threshold=[ 9.9942e-01,  9.933e-01,  9.9245e-01,  9.5594e-01,  8.2895e-01,
        -1.0000e+08]):
        ...
        for i in range(self.nBlocks):
            ...
            if args.data.startswith('cifar100'):
                ...
                self.classifier.append(
                    self._build_classifier_imagenet(nIn * args.grFactor[-1], 3))
    ...
    def _build_classifier_imagenet(self, nIn, num_classes):
        ...
        return ClassifierModule(conv, nIn*4, num_classes)
