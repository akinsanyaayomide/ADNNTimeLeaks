...
data_test = datasets.CIFAR100(root='./data', train=False, download=True, transform=transform_test)
...
for i in range(10000):
    ...
    time = round(time*int(block)/54,4)

    
    notes_path = os.path.join('.','lan_client_server_timing_skipnet_100.csv')
